...
class FdrKpiController(@Autowired private val fdrKpiService: FdrKpiService) : FdrKpiApi {
     ...
     *
     * @param brokerFiscalCode The fiscal code of the entity: - For direct PSP queries: use PSP
     ...
     * @param pspId PSP code - Required only for broker queries. - If entityCode is a broker fiscal
     *   code: this parameter is required - If entityCode is a PSP fiscal code: this parameter
     *   should not be provided (it would be a duplicate) (optional)
